...
from Pages.BasePage import BasePage, Base, Loaders
...
class ProfilePage(BasePage):
    ...
    def approve_doc(self, doc_name):
        ...
        self.click_on_elem(Alert.yes_btn)
...
class ExceedingForm(BasePage):
    ...
    def __add_exceeding(self, checkbox_locator, field_locator, select_locator, text_type, value):
        ...
        self.select_elem_exact_text(select_locator, text_type, select_locator)
        self.clear_field(field_locator)
...
class Toast(BasePage):
    ...
    def wait_until_message_appear(self):
        self.wait_until_located(self.message_commission, 'xpath')
